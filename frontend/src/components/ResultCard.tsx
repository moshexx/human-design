...
const TYPE_DESCRIPTIONS: Record<string, string> = {
  'Generator': 'The Life Force of humanity. You are built to master what you love.',
  'Manifesting Generator': 'A powerhouse of energy and speed. You are here to do it all.',
  'Projector': 'The natural guide. You are here to direct and manage others\' energy.',
  'Manifestor': 'The initiator. You are here to impact others and start new things.',
  'Reflector': 'The mirror. You are here to reflect the health of your community.',
};
  ...
  return (
    <div className="min-h-screen py-16 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <p className="field-label mb-3">✦ Your Reading Is Ready</p>
          <h1 className="gradient-text text-4xl md:text-5xl font-bold mb-2">
            {chart.name}'s Human Design
          </h1>
          <p style={{ color: '#9CA3AF' }}>Your cosmic blueprint, revealed</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-3">
              <InfoCard label="Strategy" value={strategyLabel} icon="🧭" />
              <InfoCard label="Authority" value={chart.authority} icon="⚡" />
            </div>

            {/* Defined Centers */}
            <div className="glass-card p-5">
              <div className="field-label mb-3">Defined Centers</div>
              <div className="flex flex-wrap gap-2">
                {chart.defined_centers.length > 0 ? (
                  ...
                  <span className="text-sm" style={{ color: '#9CA3AF' }}>None</span>
                )}
              </div>
            </div>
            ...
            {/* Undefined Centers */}
            <div className="glass-card p-5">
              <div className="field-label mb-3">Open Centers</div>
              <div className="flex flex-wrap gap-2">
            ...
            {chart.active_channels.length > 0 && (
              <div className="glass-card p-5">
                <div className="field-label mb-3">Active Channels</div>
                <div className="flex flex-col gap-2">
                  ...
                  {chart.active_channels.length > 6 && (
                    <p className="text-xs" style={{ color: 'rgba(156,163,175,0.5)' }}>
                      +{chart.active_channels.length - 6} more
                    </p>
                  )}
                </div>
              </div>
        ...
        >
          <p className="field-label mb-2">✦ Want to go deeper?</p>
          <h3 className="text-2xl font-bold mb-2 gradient-text" style={{ fontFamily: 'Sora, sans-serif' }}>
            Unlock Your Full Reading
          </h3>
          <p className="text-sm mb-6" style={{ color: '#9CA3AF' }}>
            Detailed gate analysis, incarnation cross, planetary activations & personalized guidance
          </p>
